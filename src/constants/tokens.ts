...
import { MAINNET_CONTRACTS, SEPOLIA_CONTRACTS, TITAN_SEPOLIA_CONTRACTS, TOKAMAK_CONTRACTS } from "./contracts";
...
export const WSWTON_ADDRESS_BY_CHAINID:Record<number, string> = {
  ...
  [SupportedChainId.SEPOLIA]: SEPOLIA_CONTRACTS.WSTON_ADDRESS
