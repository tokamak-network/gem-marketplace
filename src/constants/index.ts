...
export const GemList: GemStandard[] = [
  { id: 1, rarity: RarityType.EPIC, quadrants:[5,5,5,5], gemColor: ["#05E0FE", "#0D6CFA"], lastMineTime: 1721245218, isMining: null },
  { id: 2, rarity: RarityType.UNIQUE, quadrants:[4,4,4,4], gemColor: ["#0075FF", "#AD00FF"], lastMineTime: 1721245218, isMining: null  },
  { id: 3, rarity: RarityType.RARE, quadrants:[3,3,3,4], gemColor: ["#428EFF", "#012AFF"], lastMineTime: 1721245218, isMining: false  },
  { id: 4, rarity: RarityType.RARE, quadrants:[3,4,3,4], gemColor: ["#0094FF"], lastMineTime: 1719447784, isMining: true  },
  { id: 5, rarity: RarityType.UNIQUE, quadrants:[5,5,4,5], gemColor: ["#FF008A"], lastMineTime: 1721245218, isMining: false   },
  ...
  { id: 16, rarity: RarityType.RARE, quadrants:[3,3,4,4], gemColor: ["#61FF00", "#4299FF"], lastMineTime: 1719208712, isMining: true  },
  { id: 17, rarity: RarityType.RARE, quadrants:[3,3,4,4], gemColor: ["#61FF00", "#4299FF"], lastMineTime: 1719208712, isMining: true  },
  { id: 18, rarity: RarityType.RARE, quadrants:[3,3,4,4], gemColor: ["#61FF00", "#4299FF"], lastMineTime: 1719208712, isMining: true  },
  { id: 19, rarity: RarityType.RARE, quadrants:[3,3,4,4], gemColor: ["#61FF00", "#4299FF"], lastMineTime: 1719208712, isMining: true  },
