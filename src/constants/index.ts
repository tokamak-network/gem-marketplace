...
export const GemList: GemStandard[] = [
  ...
  { id: 2, rarity: RarityType.UNIQUE, topLeft: 4, topRight: 4, bottomLeft: 4, bottomRight: 4, gemBgColor: ["#0075FF", "#AD00FF"], lastMineTime: 1721245218, isMining: null  },
  { id: 3, rarity: RarityType.RARE, topLeft: 3, topRight: 3, bottomLeft: 3, bottomRight: 4, gemBgColor: ["#428EFF", "#012AFF"], lastMineTime: 1721245218, isMining: false  },
  ...
  { id: 5, rarity: RarityType.UNIQUE, topLeft: 5, topRight: 5, bottomLeft: 4, bottomRight: 5, gemBgColor: ["#FF008A"], lastMineTime: 1721245218, isMining: false   },
